...
export const metadata: Metadata = {
  ...
  description:
    "Discover The Foodie Wagon - your food truck for premium homemade halal burgers, crispy fried chicken, currywurst, and authentic street food in Ingolstadt. 100% halal certified. Order now!",
  keywords: [
    "foodie wagon",
  ...
  openGraph: {
    ...
    description: 'Premium homemade halal burgers, crispy fried chicken, and authentic street food in Ingolstadt. 100% halal certified.',
  ...
  twitter: {
    ...
    description: 'Premium homemade halal burgers and fried chicken in Ingolstadt. 100% halal certified.',
